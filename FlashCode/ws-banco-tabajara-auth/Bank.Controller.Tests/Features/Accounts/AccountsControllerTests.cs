...
namespace Bank.Controller.Tests.Features.Accounts
{
    ...
    public class CheckingAccountsControllerTests : TestControllerBase
    {
        ...
        [Test]
        public void CheckingAccounts_Controller_Post_ShouldHandleValidationFailure()
        {
            // Arrange
            _checkingAccountRegister.Setup(c => c.Validate().IsValid).Returns(false);
        ...
        [Test]
        public void CheckingAccounts_Controller_Put_ShouldHandleValidationFailure()
        {
            // Arrange
            _checkingAccountUpdate.Setup(c => c.Validate().IsValid).Returns(false);
        ...
        [Test]
        public void CheckingAccounts_Controller_Put_Withdraw_ShouldHandleValidationFailure()
        {
            // Arrange
            _accountTransactionCommand.Setup(c => c.Validate(TransactionType.DEBT).IsValid).Returns(false);
        ...
        [Test]
        public void CheckingAccounts_Controller_Put_Deposit_ShouldHandleValidationFailure()
        {
            // Arrange
            _accountTransactionCommand.Setup(c => c.Validate(TransactionType.CREDIT).IsValid).Returns(false);
        ...
        [Test]
        public void CheckingAccounts_Controller_Put_Transfer_ShouldHandleValidationFailure()
        {
            // Arrange
            _accountTransactionCommand.Setup(c => c.Validate(TransactionType.TRANSFER).IsValid).Returns(false);
        ...
        [Test]
        public void CheckingAccounts_Controller_Delete_Should_Be_Ok()
        {
            // Arrange
            var isUpdated = true;
