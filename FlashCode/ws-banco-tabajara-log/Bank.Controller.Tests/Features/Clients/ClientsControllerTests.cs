...
namespace Bank.Controller.Tests.Features.Clients
{
    ...
    public class ClientsControllerTests
    {
        ...
        [Test]
        public void Client_Controller_Post_ShouldHandleValidationFailure()
        {
            // Arrange
            _clientRegister.Setup(c => c.Validate().IsValid).Returns(false);
        ...
        [Test]
        public void Client_Controller_Put_ShouldHandleValidationFailure()
        {
            // Arrange
            _clientUpdate.Setup(c => c.Validate().IsValid).Returns(false);
        ...
        [Test]
        public void Client_Controller_Delete_ShouldHandleValidationFailure()
        {
            // Arrange
            _clientRemove.Setup(c => c.Validate().IsValid).Returns(false);
