    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        IdProdutoNotaFiscal = c.Long(nullable: false),
                        NotaFiscalId = c.Long(nullable: false),
                        ProdutoId = c.Long(nullable: false),
                        Quantidade = c.Int(nullable: false),
                    })
                .PrimaryKey(t => new { t.IdProdutoNotaFiscal, t.NotaFiscalId, t.ProdutoId })
                .ForeignKey("dbo.TBNOTAFISCAL", t => t.NotaFiscalId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TBTRANSPORTADOR", "EnderecoId", "dbo.TBENDERECO");
            DropForeignKey("dbo.TBTRANSPORTADOR", "DocumentoId", "dbo.TBDOCUMENTO");
            ...
            DropIndex("dbo.TBTRANSPORTADOR", new[] { "DocumentoId" });
            DropIndex("dbo.TBTRANSPORTADOR", new[] { "EnderecoId" });
